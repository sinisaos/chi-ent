...
func NewQuestionTagCreate(e *ent.QuestionTag) *QuestionTagCreate {
	if e == nil {
		return nil
	}
	var ret QuestionTagCreate
	ret.ID = e.ID
	ret.QuestionID = e.QuestionID
	ret.TagID = e.TagID
	return &ret
}

func NewQuestionTagCreates(es []*ent.QuestionTag) []QuestionTagCreate {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionTagCreate, len(es))
	for i, e := range es {
		r[i] = NewQuestionTagCreate(e).Elem()
	}
	return r
}

func (qt *QuestionTagCreate) Elem() QuestionTagCreate {
	if qt == nil {
		return QuestionTagCreate{}
	}
	return *qt
}

func NewQuestionTagList(e *ent.QuestionTag) *QuestionTagList {
	if e == nil {
		return nil
	}
	var ret QuestionTagList
	ret.ID = e.ID
	ret.QuestionID = e.QuestionID
	ret.TagID = e.TagID
	return &ret
...
func NewQuestionTagLists(es []*ent.QuestionTag) []QuestionTagList {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionTagList, len(es))
	for i, e := range es {
		r[i] = NewQuestionTagList(e).Elem()
	}
	return r
}

func (qt *QuestionTagList) Elem() QuestionTagList {
	if qt == nil {
...
func NewQuestionTagRead(e *ent.QuestionTag) *QuestionTagRead {
	if e == nil {
		return nil
	}
	var ret QuestionTagRead
	ret.ID = e.ID
	ret.QuestionID = e.QuestionID
	ret.TagID = e.TagID
	return &ret
...
func NewQuestionTagReads(es []*ent.QuestionTag) []QuestionTagRead {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionTagRead, len(es))
	for i, e := range es {
		r[i] = NewQuestionTagRead(e).Elem()
	}
	return r
}

func (qt *QuestionTagRead) Elem() QuestionTagRead {
	if qt == nil {
		return QuestionTagRead{}
	}
	return *qt
}

func NewQuestionTagUpdate(e *ent.QuestionTag) *QuestionTagUpdate {
	if e == nil {
		return nil
	}
	var ret QuestionTagUpdate
	ret.ID = e.ID
	ret.QuestionID = e.QuestionID
	ret.TagID = e.TagID
	return &ret
...
func NewQuestionTagUpdates(es []*ent.QuestionTag) []QuestionTagUpdate {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionTagUpdate, len(es))
	for i, e := range es {
		r[i] = NewQuestionTagUpdate(e).Elem()
	}
	return r
}

func (qt *QuestionTagUpdate) Elem() QuestionTagUpdate {
	if qt == nil {
		return QuestionTagUpdate{}
	}
	return *qt
}

func NewQuestionTagQuestionRead(e *ent.Question) *QuestionTagQuestionRead {
	if e == nil {
		return nil
	}
	var ret QuestionTagQuestionRead
	ret.ID = e.ID
	ret.Title = e.Title
	ret.Content = e.Content
	ret.CreatedAt = e.CreatedAt
...
func NewQuestionTagQuestionReads(es []*ent.Question) []QuestionTagQuestionRead {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionTagQuestionRead, len(es))
	for i, e := range es {
		r[i] = NewQuestionTagQuestionRead(e).Elem()
	}
	return r
}

func (q *QuestionTagQuestionRead) Elem() QuestionTagQuestionRead {
	if q == nil {
		return QuestionTagQuestionRead{}
	}
	return *q
}

func NewQuestionTagTagRead(e *ent.Tag) *QuestionTagTagRead {
	if e == nil {
		return nil
	}
	var ret QuestionTagTagRead
	ret.ID = e.ID
	ret.Name = e.Name
	return &ret
}

func NewQuestionTagTagReads(es []*ent.Tag) []QuestionTagTagRead {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionTagTagRead, len(es))
	for i, e := range es {
		r[i] = NewQuestionTagTagRead(e).Elem()
	}
	return r
}

func (t *QuestionTagTagRead) Elem() QuestionTagTagRead {
	if t == nil {
		return QuestionTagTagRead{}
	}
	return *t
}
...
func NewQuestionQuestionTagList(e *ent.QuestionTag) *QuestionQuestionTagList {
	if e == nil {
		return nil
	}
	var ret QuestionQuestionTagList
	ret.ID = e.ID
	ret.QuestionID = e.QuestionID
	ret.TagID = e.TagID
	return &ret
...
func NewQuestionQuestionTagLists(es []*ent.QuestionTag) []QuestionQuestionTagList {
	if len(es) == 0 {
		return nil
	}
	r := make([]QuestionQuestionTagList, len(es))
	for i, e := range es {
		r[i] = NewQuestionQuestionTagList(e).Elem()
	}
	return r
}

func (qt *QuestionQuestionTagList) Elem() QuestionQuestionTagList {
	if qt == nil {
		return QuestionQuestionTagList{}
	}
	return *qt
}
...
func NewTagTagQuestionList(e *ent.QuestionTag) *TagTagQuestionList {
	if e == nil {
		return nil
	}
	var ret TagTagQuestionList
	ret.ID = e.ID
	ret.QuestionID = e.QuestionID
	ret.TagID = e.TagID
	return &ret
...
func NewTagTagQuestionLists(es []*ent.QuestionTag) []TagTagQuestionList {
	if len(es) == 0 {
		return nil
	}
	r := make([]TagTagQuestionList, len(es))
	for i, e := range es {
		r[i] = NewTagTagQuestionList(e).Elem()
	}
	return r
}

func (qt *TagTagQuestionList) Elem() TagTagQuestionList {
	if qt == nil {
		return TagTagQuestionList{}
	}
	return *qt
}
